   ...
   return (
      <React.Fragment>
         ...
         <CustomBodyDescription title={'Descripcion'} height={'150px'}>
            Este componente se encarga de verificar un documento previamente firmado
         </CustomBodyDescription>

         <CustomBody>
            <CustomCard>
               <CustomCardHeader>
                  <h3> Por favor suba su documento, para poder realizar su respectiva comprobacion </h3>
               </CustomCardHeader>
